          ...
          <div class="col-md-12">
            <ul class="grid-holder col-3 events-grid isotope" style="position: relative; overflow: hidden; height: 1040.34px;">
                <li class="grid-item format-standard isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate(0px, 0px);">
                  <div class="grid-item-inner"> <a href="#" class="media-box"> <img src="{{ asset('/images/ecole-du-saint-esprit.jpeg') }}" alt=""> <span class="zoom" style="width: 224px; height: 224px; line-height: 224px;"><i class="fa fa-plus"></i></span></a>
                ...
                <li class="grid-item format-standard isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate(0px, 0px);">
                  <div class="grid-item-inner"> <a href="#" class="media-box"> <img src="{{ asset('/images/evenement de mai.jpeg') }}" alt=""> <span class="zoom" style="width: 224px; height: 224px; line-height: 224px;"><i class="fa fa-plus"></i></span></a>
                    <div class="grid-content">
                      <h3><a href="#">Conférences annuelle</a></h3>
                      <p>Conférences annuelle  de M.E.I.C.G du 25 au 26 mai 2018
                      </p>
                      <p>Vendredi 25 Mai  de 16h à 20h
                      </p>
                      <p>Samedi 26 Mai  de 14h à 18h
                      </p>
                    </div>
                    <ul class="info-table">
                ...
                <li class="grid-item format-standard isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate(0px, 0px);">
                  <div class="grid-item-inner"> <a href="#" class="media-box"> <img src="{{ asset('/images/gallery-img111.jpg') }}" alt=""> <span class="zoom" style="width: 224px; height: 224px; line-height: 224px;"><i class="fa fa-plus"></i></span></a>
                    <div class="grid-content">
                ...
                <li class="grid-item format-standard isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate(0px, 0px);">
                  <div class="grid-item-inner"> <a href="#" class="media-box"> <img src="{{ asset('/images/gallery-img34.jpg') }}" alt=""> <span class="zoom" style="width: 224px; height: 224px; line-height: 224px;"><i class="fa fa-plus"></i></span></a>
                    ...
                    <ul class="info-table">
                      <li><i class="fa fa-calendar"></i>Juillet 2018 </li>
                      <li><i class="fa fa-map-marker"></i> 93200 Saint-Denis RER D, FR</li>
                    </ul>
                  </div>
                </li>
