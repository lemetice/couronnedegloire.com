                ...
                <div class="grid-item-inner">
                  <div class="media-box">
                    ...
                    <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 800%; transition-duration: 0s; transform: translate3d(-314px, 0px, 0px);"><li class="item clone" style="width: 314px; float: left; display: block;"><a href="{{ asset('/images/gallery-img3.jpg') }}" data-rel="prettyPhoto[postname]"><img src="{{ asset('/images/gallery-img3.jpg') }}" alt=""></a></li>
                        <li class="item flex-active-slide" style="width: 314px; float: left; display: block;"><a href="{{ asset('/images/gallery-img112.jpg') }}" data-rel="prettyPhoto[postname]"><img src="{{ asset('/images/gallery-img112.jpg') }}" alt=""></a></li>
                      ...
                      <li class="item clone" style="width: 314px; float: left; display: block;"><a href="{{ asset('/images/gallery-img111.jpg') }}" data-rel="prettyPhoto[postname]"><img src="{{ asset('/images/gallery-img111.jpg') }}" alt=""></a></li></ul></div><ol class="flex-control-nav flex-control-paging"><li><a class="flex-active">1</a></li><li><a class="">2</a></li></ol><ul class="flex-direction-nav"><li><a class="flex-prev" href="#"></a></li><li><a class="flex-next" href="#"></a></li></ul></div>
                  </div>
                </div>
              </li>
